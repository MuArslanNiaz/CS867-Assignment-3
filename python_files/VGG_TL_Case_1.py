...
plt.title('Loss/Accuracy Per Epoch Case 1')
plt.xlabel('Epoch #')
...
model.save_weights('vgg_transfer_trained_wts_case_1.h5')
!cp "/content/vgg_transfer_trained_wts_case_1.h5" "/content/drive/MyDrive/cv/vgg_transfer_trained_wts_case_1.h5"

# Validate model
score = model.evaluate(datagenerator_test, batch_size=64)
print('Test Loss Case 1 = ', score[0])
print('Test Accuracy Case 1 = ', score[1])
